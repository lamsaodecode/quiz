angular
  .module("ngQuiz", ["ngSanitize"])
  .controller("ngQuizController", function (
    $scope,
    $timeout,
    quizProgress,
    scoreKeeper
    ...
    $scope.quizData = {
      quizMetadata: {
        ...
        introImg:
          "http://interactive.wttw.com/sites/default/files/styles/small-hero/public/B12_b.jpg",
      ...
      quizQuestions: [
        {
          ...
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q1.jpg",
          feedback:
            "Before the “L” came to the Loop, steam-powered cable cars circulated downtown, giving the area its name. Later, the elevated tracks and trains of the “L” made the Loop even more accessible to people throughout the Chicago region.",
          options: [
            {
            ...
            {
              name:
                "Cable cars that circulated downtown before the “L” was built.",
              correct: true,
            },
            {
...

        {
          ...
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q2.jpg",
          feedback:
        ...
        {
          question:
            "What Chicago Loop building, now demolished, is considered the “first skyscraper”?",
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q3.jpg",
          feedback:
            "The nine-story Home Insurance Building, completed in 1885, was the first building fully framed with metal columns and beams, and so was considered to be the first skyscraper. It was demolished in 1931. Its architect, William LeBaron Jenney, is considered the father of the American skyscraper for his structural engineering innovations.",
          options: [
            {
        ...
        {
          question:
            "Architectural preservationist Richard Nickel said, “Great architecture has only two natural enemies.” What are they, according to Nickel?",
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q4.jpg",
          feedback:
            "Richard Nickel was a young photography student at Illinois Institute of Technology when he first encountered Louis Sullivan’s work. He began documenting Sullivan buildings in photographs; later, he fought for their preservation.<br/><br/> When he couldn’t save the buildings, he salvaged ornament from them. Nickel lost his life in the old Chicago Stock Exchange Building  when it partially collapsed during its demolition in 1972.",
          options: [
            {
...

        {
          ...
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q5.jpg",
          feedback:
            "Sullivan was famous for his idea that form follows function. His designs, such as for the Carson Pirie Scott department store (shown here), expressed the buildings’ purpose with an honesty and elegance that foreshadowed modern architecture.<br/><br/>He wrote: “What is the chief characteristic of the tall office building? It is lofty ... It must be tall, every inch of it tall ... a proud and soaring thing, rising in sheer exultation … without a single dissenting line.”",
          options: [
            {
...

        {
          ...
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q6_0.jpg",
          feedback:
        ...
        {
          question:
            "Architect Bruce Graham once famously demonstrated how the Sears Tower (now Willis Tower) would be constructed using:",
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q7.jpg",
          feedback:
        ...
        {
          question:
            "The “Chicago School” style of architecture includes a façade design that reflects:",
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q8.jpg",
          feedback:
            "The Marquette Building (shown here) serves as an example of the Chicago School style of architecture. It has a three-part façade that parallels a classical column — a clearly identified base, a vertical shaft of floors above, and an ornamented cornice that signifies the capital, or top, of the column.",
          options: [
            {
...

        {
          ...
          questionImg:
            "http://interactive.wttw.com/sites/default/files/styles/hero/public/Q9.jpg",
          feedback:
            "The Chicago window has a large, fixed central pane of glass, flanked by two operable narrow sashes. This window design became popular in the 1890s partly because it allowed for natural light and ventilation year round.",
          options: [
            {
    ...
    $scope.nextQuestion = function () {
      if (quizProgress.currentQuestion < quizProgress.lastQuestion) {
        ...
        quizProgress.currentQuestionFriendly =
    ...
    $scope.answerQuestion = function (data) {
      ...
      angular.forEach(
        $scope.quizQuestions[quizProgress.currentQuestion].options,
        function (obj) {
  ...
  .directive("imagePreload", function (quizProgress) {
    return {
      restrict: "EA",
      template:
        "<img style='display:none;' ng-src='{{quizQuestions[quizProgress.imageToPreload].questionImg}}'/>",
    };
  })
